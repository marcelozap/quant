...
The current builder already creates the first Green Gate landmark, a dressed route blockout, Rosco interest points, and a local `XIVAudioAtmosphere` component. These are foundations for the gates below, not evidence that the final art or audio experience is complete.
